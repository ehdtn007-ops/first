...
// 1차에서 실패한 매물들 - 실제 존재하는 다른 지번으로 교체
const RETRY_ADDRESSES = {
  'b13': { prov:'서울', area:'종로구', dong:'관철동', jibun:'13-1', floor:'3-6' },
  'b14': { prov:'서울', area:'영등포구', dong:'영등포동3가', jibun:'7-6', floor:'3-5' },
  'b15': { prov:'서울', area:'영등포구', dong:'문래동2가', jibun:'8', floor:'2-5' },
  'b17': { prov:'서울', area:'강서구', dong:'화곡동', jibun:'352-1', floor:'2-4' },
  'b18': { prov:'서울', area:'성북구', dong:'안암동3가', jibun:'166', floor:'2-3' },
  'b2':  { prov:'서울', area:'서초구', dong:'서초동', jibun:'1446-2', floor:'3-4' },
  'b20': { prov:'서울', area:'동대문구', dong:'용두동', jibun:'126-2', floor:'2-5' },
  'b21': { prov:'서울', area:'중구', dong:'충무로3가', jibun:'24-9', floor:'3-6' },
  'b22': { prov:'서울', area:'중구', dong:'남대문로5가', jibun:'6-1', floor:'2-9' },
  'b25': { prov:'서울', area:'은평구', dong:'녹번동', jibun:'5-12', floor:'2-3' },
  'b26': { prov:'서울', area:'도봉구', dong:'창동', jibun:'693-1', floor:'2-3' },
  'b27': { prov:'서울', area:'강북구', dong:'수유동', jibun:'49-1', floor:'2-5' },
  'b28': { prov:'서울', area:'양천구', dong:'목동', jibun:'404-17', floor:'3' },
  'b29': { prov:'서울', area:'양천구', dong:'신정동', jibun:'159', floor:'2-4' },
  'b31': { prov:'서울', area:'관악구', dong:'봉천동', jibun:'729-21', floor:'2-3' },
  'b33': { prov:'서울', area:'성동구', dong:'행당동', jibun:'168-151', floor:'2-3' },
  'b34': { prov:'서울', area:'성동구', dong:'성수동1가', jibun:'16-1', floor:'2-5' },
  'b35': { prov:'서울', area:'중랑구', dong:'면목동', jibun:'608', floor:'2-3' },
  'b37': { prov:'서울', area:'구로구', dong:'구로동', jibun:'636-70', floor:'2-5' },
  'b4':  { prov:'서울', area:'마포구', dong:'아현동', jibun:'387-16', floor:'2-3' },
  'b42': { prov:'서울', area:'노원구', dong:'중계동', jibun:'357-4', floor:'2-5' },
  'b43': { prov:'서울', area:'서초구', dong:'방배동', jibun:'793-3', floor:'2-3' },
  'b44': { prov:'서울', area:'은평구', dong:'응암동', jibun:'26-15', floor:'2-5' },
  'b46': { prov:'서울', area:'강남구', dong:'역삼동', jibun:'832-7', floor:'2-6' },
  'b6':  { prov:'서울', area:'용산구', dong:'이태원동', jibun:'34-48', floor:'2-6' },
  'b7':  { prov:'서울', area:'송파구', dong:'방이동', jibun:'186-1', floor:'2-7' },
  'b8':  { prov:'서울', area:'강남구', dong:'논현동', jibun:'166-4', floor:'2-5' },
  'b9':  { prov:'서울', area:'용산구', dong:'이태원동', jibun:'258-36', floor:'2-7' },
};
...
async function main() {
  ...
  console.log('2차 업데이트: ' + Object.keys(RETRY_ADDRESSES).length + '건\n');

  let success = 0, fail = 0, noBldg = 0;
  const lids = Object.keys(RETRY_ADDRESSES);

  for (let i = 0; i < lids.length; i++) {
    const lid = lids[i];
    const addr = RETRY_ADDRESSES[lid];
    try {
      ...
      const update = {
        prov: addr.prov, area: addr.area, dong: addr.dong, jibun: addr.jibun, floor: addr.floor,
      };
